...
//        List<Bid> actualResult = auctionManager.getAllBids(item);
...
//        auctionManager.recordUserBid(item, bid3);
//        assertEquals(3, auctionManager.getAllBids(item).size());
//        List<Bid> allBids = auctionManager.getAllBids(item);
